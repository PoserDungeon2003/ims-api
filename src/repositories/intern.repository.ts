...
import {Intern, InternRelations, InternTask, Tasks, TrainingProgram, Users, WorkResult, Feedback} from '../models';
...
> {
  ...
  constructor(
    ...
    @repository.getter('TrainingProgramRepository') protected trainingProgramRepositoryGetter: Getter<TrainingProgramRepository>, @repository.getter('FeedbackRepository') protected feedbackRepositoryGetter: Getter<FeedbackRepository>,
  ) {
